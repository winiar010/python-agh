...
class Application(Frame):
    ...
    def reveal(self):
        ...
        contents = self.pw_ent.get() #pobranie wartości, która została wpisana przez użytkownika do zmiennej contents
        ...
        self.secret_txt.delete(0.0, END)            #zawsze najpierw czyść pole
